...
public class RepeatingBackground : MonoBehaviour {
    ...
    private BoxCollider groundCollider;       //This stores a reference to the collider attached to the Ground.
    ...
    private void RepositionBackground()
    {
        ...
        Vector3 groundOffSet = new Vector3(groundHorizontalLength * 2f, 0);
